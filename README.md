...
- `index.html` is the current latest version, copied from `versions/Thyroid_K_TIRADS_2021_ver0.39.html`.
...
- ver0.39: Restored the Thyroid diagram light-mode card background styling, centered the Postop diagram more consistently, and added Thyroid-like marker dragging/resizing behavior to Postop residual nodules plus draggable lesion markers for op-bed lesions.
- ver0.38: Made the Postop diagram open the same kind of popup input window as Thyroid diagram clicks, and tightened the diagram layout so postoperative lesions remain easier to compare visually with Thyroid nodule cards.
