...
- 현재 버전: **ver2.0006** (`Thyroid_KTIRADS_ver2.0006.html` — 스냅샷은 **저장소 루트**에 있다.
...
아직 남은 것: 어긋난 font-size 13곳(`11.5px` 등), raw radius 16곳, 하드코딩 색상,
컨트롤 높이 20종. 색상은 `body.light`에서 안 바뀌므로 라이트 모드 대비가 깨질 위험이 있다.
