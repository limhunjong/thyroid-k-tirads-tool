...
- 현재 버전: **ver2.0008** (`Thyroid_KTIRADS_ver2.0008.html` — 스냅샷은 **저장소 루트**에 있다.
...
**남은 기존 버그:** 상단바가 좁은 화면에서 넘친다 (768px에서 316px, 834px에서 250px,
1024px에서 60px). 아이패드 세로에서 오른쪽 버튼이 화면 밖으로 나간다. 아직 안 고쳤다.
